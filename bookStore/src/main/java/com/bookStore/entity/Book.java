...
public class Book {
	...
	public Book(int id, String author, String name, String genre, int amount, String price, String link, byte[] image, String description, String comment, String commentName, String commentDate, String dateStartReading, String dateStopReading, Boolean favourites, String status) {
		super();
		this.id = id;
		this.author = author;
		this.name = name;
